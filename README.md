...
## 🚀 Giới thiệu
Dự án này được phát triển bằng ngôn ngữ **Java** và thư viện **JavaFX**, áp dụng mô hình kiến trúc **MVC** và các mẫu thiết kế hiện đại. Ứng dụng cho phép người dùng vẽ đồ thị, nhập dữ liệu từ file và chạy mô phỏng trực quan các thuật toán từ cơ bản đến nâng cao.
...
```bash
git clone [https://github.com/your-username/graph-visualizer.git](https://github.com/your-username/graph-visualizer.git)

```

**2. Mở trong IntelliJ IDEA:**

* Vào `File` -> `Open` -> Chọn thư mục project.
* Đợi IDE index và tải thư viện.

**3. Cấu hình chạy (Nếu cần):**
Nếu gặp lỗi JavaFX runtime, hãy thêm đoạn sau vào **VM Options**:
...
* Tìm file `MainApp.java` trong thư mục `src` và nhấn nút **Run**.
...
* **Cách 1 (Thủ công):** Nhập số đỉnh, nhập danh sách cạnh vào ô text và bấm **"Cập nhật Đồ thị"**.
* *Ví dụ:* `1 2 10` (nghĩa là cạnh nối từ đỉnh 1 đến đỉnh 2 có trọng số 10).
...
3. Bấm nút **Run Algorithm**.
4. Kéo thanh trượt để điều chỉnh tốc độ mô phỏng mong muốn.
